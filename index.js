...
const UUID = process.env.UUID || '91de34c5-b4a2-406d-80e5-ef97b69d1d43'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'opppqw.xcctt.nyc.mn';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNTY2M2Q3YmY0M2NmZGU1MDYzMjhmNjZmMDJmM2RhMDAiLCJ0IjoiOTdlNjNhMDAtNzM2MC00ZDE3LThhMDgtNGIwYjk4NDUxNWIzIiwicyI6Ik9HWXpZbVptT0RrdE1UWXlZaTAwTURFNUxXRTVPVFV0TVdNM1l6QmlOMlF6WlRBNSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const CHAT_ID = process.env.CHAT_ID || '7886284400';                  // Telegram chat_id  两个变量不全不推送节点到TG 
const BOT_TOKEN = process.env.BOT_TOKEN || '7669258945:AAGNTd8625Oy6h3oWN8en1EfDn2ZY0BjpHc';              // Telegram bot_token 两个变量不全不推送节点到TG 
